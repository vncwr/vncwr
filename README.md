...
**What I build:** web apps, REST APIs, dashboards, automation/scrapers, and chatbots. Recent work includes a tournament registration platform for a Moonton Games esports event (thousands of concurrent users) and a full-stack platforms.

[vincewarrenpradas.dev](https://vincewarrenpradas.dev) · vincepradas.business@gmail.com

Some client projects are private under NDA — happy to walk through them on request with client approval.
